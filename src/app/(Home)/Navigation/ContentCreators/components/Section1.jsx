...
const Section1 = () => {
	const data =[
		{
			heading:"STEP 1",
			content:"Connect with us by filling out our simple application form on the website."
		},
		{
			heading:"STEP 2",
			content:"Our team will promptly reach out to you to discuss potential content ideas and partnership opportunities."
		},
		{
			heading:"STEP 3",
			content:"Start creating and sharing engaging content to enhance language learning with us! "
		},
	]
	return (
		<>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-auto">
					
						{
							...
							<div className="bg-white   rounded-lg border border-primary-color text-xl   mt-5   text-center">
								<h5 className="bg-primary-color py-3 mb-5 text-white">{val.heading}</h5>
