...
const GermanForKidsPage = () => {
  const data = {
    ...
    WhyKidsShouldLearn: {
      Title: "Why kids should learn German?",
      CardData: [
        {
    ...
    WhyLearnLanguage: {
      ...
      CardData1: {
        title: "Global Communication",
        info: "German has 1.5 billion speakers globally and fosters connections across German-speaking nations, enhancing global understanding and communication opportunities for children.",
      },
      CardData2: {
        title: "Academic Advantages",
        info: "Mastery of German enhances access to educational resources, research, and opportunities for higher education.",
      },
      CardData3: {
        title: "Career Opportunities",
        info: "Proficiency in German opens doors in various industries, including business, technology, and tourism, offering competitive advantages in the global job market.",
      },
      CardData4: {
        title: "Cultural Enrichment",
        info: "Learning German exposes children to diverse literature, music, films, and popular culture from German-speaking countries.",
      },
      CardData5: {
        title: "Travel and Exploration",
        info: "German proficiency enhances travel experiences and fosters deeper engagement with German-speaking regions, such as the United States, United Kingdom, Canada, Australia, and more.",
      },
    },
    Faqs: [
      {
      ...
      {
        question: "Why is learning German beneficial for children?",
        answer:
          "Learning German at a young age offers numerous advantages, including cognitive development, academic success, and cultural enrichment.",
      },
      {
        question: "At what age should children start learning German?",
        answer:
          "Children can start learning German as early as primary school age to benefit from enhanced cognitive abilities and language acquisition skills.",
      },
      {
        question:
          "What resources are available to help children learn German effectively?",
        answer:
          "Your child will be provided with comprehensive study material worth ₹10,000+ free of cost to supplement their learning and reinforce key concepts.",
      },
      {
        question:
          "What levels are assessed in the Goethe-Zertifikat for children?",
        answer:
          "The Goethe-Zertifikat exams assess language proficiency at different levels corresponding to the Common European Framework of Reference for Languages (CEFR): A1, A2, B1, and B2.",
      },
      {
        question:
          "How can parents ensure their child's success in learning German?",
        answer:
          "Parents can monitor their child's progress by screening their weekly assessments and performance. Additionally, Parents can facilitate their child's proficiency in German by establishing a nurturing environment at home and promoting consistent language practice through diverse activities.",
      },
    ],
