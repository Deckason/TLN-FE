...
const FaqsSudyAbroad = () => {
  const datas = [
    ...
    },
    {
      ...
      answer:
        "Upon completing your Mandarin course, you'll gain access to job opportunities in fields like translation, tourism, international relations, teaching, business, diplomacy, and more.",
    },
    {
