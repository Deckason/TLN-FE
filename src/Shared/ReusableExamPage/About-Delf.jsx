  ...
  return (
    <div className="mt-10">
      <div className="w-full  justify-center items-center flex-col flex">
        <div className=" p-5 w-full lg:w-[1000px] xl:w-[1275px] 2xl:w-[1400px] 3xl:w-[1500px] justify-center items-center flex-col flex">
          <div className="lg:text-[30px] text-[20px] xl:text-[40px] font-bold text-center">
            {data.data.title}
          </div>
        </div>
        <div className=" gap-10 p-5 w-full lg:w-[1000px] xl:w-[1275px] 2xl:w-[1400px] 3xl:w-[1500px] justify-center items-center xl:flex-row lg:flex-row flex-col flex">
