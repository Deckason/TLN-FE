...
const LanguageClassesForAnyLevel = ({ ClassesForAnyLevel }) => {
  ...
  return (
    <div className=" mt-[112px] w-full mx-auto">
        ...
        <div
          className={`${ClassesForAnyLevel?.CardData?.length === 3 && "xl:grid-cols-3"
            } ${ClassesForAnyLevel?.CardData?.length === 4 && "xl:grid-cols-4"} ${ClassesForAnyLevel?.CardData?.length === 1 ? "grid" : ""
            } md:grid 2xl:max-w-[1640px] max-w-8xl justify-center max-md:hidden max-md:gap-5 md:gap-2 px-5 mx-auto max-sm:px-4 w-full lg:gap-[18px] gap-8 md:grid-cols-2  items-center mt-[48px] `}
        >
