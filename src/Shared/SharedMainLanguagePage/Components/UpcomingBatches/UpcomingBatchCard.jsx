      ...
      <div className="2xl:w-[408px] shadow-md hover:shadow-2xl transition duration-300  lg:scale-100   flex-col justify-start items-start gap-2.5  rounded-xl  shadow-[#bab8b8]/40 flex">
        <div className="h-[160px] max-sm:h-[330px]  bg-[#F7DF10] rounded-t-xl flex items-center  w-full relative">
          ...
          <Image
            alt="girlRashi"
            src={data.img}
            className="object-cover lg:object-contain w-full h-full z-10"
          ></Image>
        </div>
        <div className="p-4   rounded-b-lg flex-col justify-start w-full items-start gap-8 flex">
          <div className="self-stretch flex-col justify-start items-start  flex">
            ...
            <div className=" w-full flex-col justify-start items-start flex">
              <div className="self-stretch  pt-5 pb-4 border-b border-neutral-200 justify-between items-center inline-flex">
                <div className="w-[122px] h-[23px] text-stone-900 text-base max-sm:text-sm font-medium ">
                  Batch Starts{" "}
                </div>
                <div className="text-stone-900  text-[15px] max-sm:text-sm font-bold ">
                  {data.batch}
                </div>
              </div>
              <div className="self-stretch py-5 border-b border-neutral-200 justify-between items-center inline-flex">
                <div className="w-[159px]  text-stone-900 text-base max-sm:text-sm font-medium ">
                  Number of seats
                </div>
                <div className="text-stone-900 max-sm:text-sm font-bold ">
                  {data.seats}
                </div>
              </div>
              <div className="self-stretch py-5 border-b border-neutral-200 justify-between items-center flex">
                <div className="  text-stone-900 text-base max-sm:text-sm font-medium ">
                  Timing
                </div>
              ...
              <div className="self-stretch  py-5 border-b border-neutral-200 justify-between items-center inline-flex">
                <div className="w-[120px] h-[23px] text-stone-900 text-base max-sm:text-sm font-medium ">
                  Certification{" "}
                </div>
