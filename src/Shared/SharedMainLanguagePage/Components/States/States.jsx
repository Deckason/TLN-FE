...
const States = () => {
  ...
  return (
    <div className="flex justify-center  w-full items-center">
      <div className="lg:w-[1000px] 2xl:w-[1684px] max-lg:min-h-[199px] py-[25px] 2xl:py-[52px] xl:w-full xl:mx-4 bg-white z-10 rounded-2xl border border-stone-300 flex-col max-sm:mx-4 justify-center items-center mt-[25.5px] flex">
        <div className="justify-around w-full 3xl:gap-[90px] items-center  flex-wrap scale-90 flex">
          <div className="flex-col justify-center items-center gap-2 inline-flex w-full lg:w-auto">
            <div className="text-center text-stone-900 max-sm:text-3xl text-4xl 2xl:text-5xl font-bold">
              7
            </div>
          ...
          <div className="flex-col justify-center items-center gap-2 inline-flex w-full lg:w-auto">
            <div className="text-center max-sm:text-3xl text-stone-900 text-4xl 2xl:text-5xl font-bold">
              5000+
            </div>
          ...
          <div className="flex-col justify-start items-center gap-2 inline-flex w-full lg:w-auto">
            <div className="justify-start items-center gap-2 flex">
              <div className="text-center text-stone-900 text-4xl 2xl:text-5xl justify-center items-center max-sm:text-3xl font-bold gap-x-[8px] flex">
