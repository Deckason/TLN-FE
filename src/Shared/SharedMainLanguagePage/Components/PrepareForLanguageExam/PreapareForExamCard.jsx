...
const PreapareForExamCard = ({ data }) => {
  return (
    <div className="">
      <div className="w-auto shadow-md hover:shadow-xl transition duration-300 rounded-xl  max-xl:h-[620px] min-h-[509px] flex-col justify-center items-center gap-8 inline-flex p-4">
