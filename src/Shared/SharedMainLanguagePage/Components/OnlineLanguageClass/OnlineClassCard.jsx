...
const OnlineClassCard = ({ data }) => {
  return (
    <div>
      <div className="w-full shadow-md hover:shadow-xl transition duration-300
        rounded-xl min-h-[509px] flex-col justify-start items-center gap-8  inline-flex p-4">
        ...
        <div className="w-full  h-full   max-lg:max-h-[350px] lg:min-h-[295px] flex-col justify-start items-center gap-8 flex">
          ...
          <div className="self-stretch mx-4 mb-4 h-14 flex-col justify-center items-center gap-2.5 flex">
            <Link
              href={data?.link}
              className="self-stretch h-14 shadow-md hover:shadow-xl transition duration-300 px-8 py-3.5 rounded-lg border border-teal-600 justify-center items-center gap-2.5 inline-flex"
            >
