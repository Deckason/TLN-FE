  ...
  return (
    <div className=" my-[112px] w-full mx-auto">
      ...
      <div
        ...
        } xl:grid 2xl:max-w-[1640px] max-w-8xl justify-center gap-1 max-md:gap-5 md:gap-2 px-5 mx-auto max-sm:px-4 w-full lg:gap-[18px] md:grid-cols-2  items-center mt-[48px] `}
      >
