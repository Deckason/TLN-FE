...
const SharedAdultsPage = ({ Data, language }) => {
  ...
  return (
    <div className="px-[16px] 2xl:px-[88px] 4xl:[120px]">
      ...
      <div className="2xl:max-w-[1680px] lg:mx-10 mx-auto 2xl:mx-[100px]  relative 3xl:mx-auto  flex justify-center items-center flex-col mb-[12px] xl:mb-[31px] 4xl:mb-[112px]">
        <WhyShould />
        <div className="">
