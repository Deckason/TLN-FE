  ...
  return (
    <div>
      <div className="w-full shadow-xl shadow-neutral-color/15 rounded-xl min-h-[509px] flex-col justify-start items-center gap-8 inline-flex">
        <div className="self-stretch h-[212px] py-[72px] mb-8 rounded-xl flex-col justify-start items-center gap-2.5 flex">
          <Image alt="levelImages" src={data?.img}></Image>
        </div>
        <div className="w-full min-h-[255px] flex-col justify-start items-center gap-8 flex">
          <div className="self-stretch text-center text-neutral-800 text-2xl font-medium font-['Inter'] mt-4">
            {data?.title}
          </div>
