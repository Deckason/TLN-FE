...
const FaqsLanguage = ({ FaqsData }) => {
  ...
  return (
    <div className="2xl:max-w-[1680px]  bg-[#F6F3F3]  px-4 lg:px-10 mx-auto 2xl:px-[100px] 3xl:mx-auto relative flex justify-center items-center flex-col max-md:py-0">
