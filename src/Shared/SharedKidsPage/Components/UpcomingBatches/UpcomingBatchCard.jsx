...
const UpcomingBatchCard = ({ data }) => {
  return (
    <div>
      <div className=" mx-4 lg:scale-100 shadow-md transition duration-300 hover:shadow-2xl  p-4 flex-col justify-start items-start gap-2.5  rounded-xl  shadow-[#bab8b8]/40 flex">
