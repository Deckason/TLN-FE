...
const States = () => {
  ...
  return (
    <div className="flex justify-center  w-full items-center">
      <div className="lg:w-[1000px] 2xl:w-[1684px] max-lg:min-h-[199px] shadow-md transition duration-300 hover:shadow-2xl max-sm:pt-0 py-[25px] 2xl:py-[52px] xl:w-full xl:mx-4 bg-white z-10 rounded-2xl border border-stone-300 flex-col max-sm:mx-4 max-sm:w-[190px] max-lg:w-[350px] justify-center items-center mt-[25.5px] flex">
