...
const UpcomingBatchCard = ({ data }) => {
  return (
    <div>
      <div className="  lg:scale-100 transition duration-300 shadow-md hover:shadow-2xl  p-4 flex-col justify-start items-start gap-2.5  rounded-xl  shadow-[#bab8b8]/40 flex">
