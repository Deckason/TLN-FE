    ...
    <div className="w-full -mt-14">
      <div className="w-full  bg-teal-600 min-h-[380px] relative flex justify-center items-center">
        <div className=" bg-teal-600 absolute w-full flex-col justify-center items-center gap-8 inline-flex">
          ...
          <div className="">
            <form className="justify-center items-end gap-8 flex-wrap flex" onSubmit={(e)=>e.preventDefault()}>
              <div className="">
                <input
                  required
                  type="email"
              ...
              <button className="h-[39px] xl:h-[60px] w-[180px] px-8 py-[24px] bg-neutral-50 hover:scale-105 rounded-lg justify-center items-center gap-2.5 flex " type="submit">
