...
const HowItWorksCard = ({ datas }) => {
  return (
    <div className="flex flex-col bg-white p-6 text-center  rounded-2xl min-h-full h-[548px] mx-2 md:mx-0 md:max-w-sm max-md:w-[355px] justify-center max-xl:w-[408px] xl:max-w-[388px] ">
