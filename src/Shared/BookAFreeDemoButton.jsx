...
const BookAFreeDemoButton = () => {
  ...
  return (
    <div
      onClick={toggleModal}
      className="flex mt-8 md:mt-12 lg:mt-16 justify-start  lg:ml-6 xl:ml-0"
    >
    ...
    Get started
      ...
      <button data-tally-open="3qORRk" data-tally-layout="modal" className="px-[16px] xl:px-[32px] py-[10px] xl:px[14px] bg-teal-600 rounded-lg text-[14px] 2xl:text-[24px] font-medium text-neutral-50 flex items-center gap-2.5 hover:bg-neutral-50 hover:text-teal-600 border-2 border-teal-600 transition-colors duration-200">
        Get started
      </button>
    </div>
  );
