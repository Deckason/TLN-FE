  ...
  return (
    <div className="flex justify-start">
      <button
        ...
        className="mx-[16px] w-[152px] sm:w-[279px] h-[43px] sm:h-[58px] py-[12px] px-[32px] text-[16px]/[19.26px] sm:text-2xl font-medium shadow-md hover:shadow-xl transition focus:bg-white 
