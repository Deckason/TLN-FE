...
const TechersInfo = () => {
  return (
    <div className="pt-[40px] lg:pb-[112px] lg:flex block flex-col justify-center items-center px-[18px] sm:px-[72px] lg:px-10 2xl:px-[100px] 3xl:mx-auto">
      <div className="max-w-[1681px] lg:p-[16px] justify-center items-center 4xl:gap-[72px] gap-[16px] lg:gap-[40px] flex-col 4xl:flex-row flex ">
        ...
        <div className="self-center hidden lg:flex 4xl:hidden h-[58px] flex-col inset-x-0 bottom-0 justify-start items-start gap-2.5  ">
          <BookAFreeDemoButton />
        </div>
      </div>
    </div>
