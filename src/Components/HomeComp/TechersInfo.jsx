...
const TechersInfo = () => {
  return (
    <div className="lg:py-[112px] lg:flex block flex-col justify-center items-center p-20">
      <div className="max-w-[1681px] p-5 justify-center items-center 2xl:gap-[72px] gap-[16px] lg:gap-[36px] flex-col 2xl:flex-row flex ">
        <div className="w-full 2xl:w-[490px] 2xl:h-[495px] flex-col justify-center items-center gap-10 max-2xl:self-start  inline-flex">
          <div className="self-start 2xl:h-[389px] flex-col justify-start items-start gap-4 2xl:gap-8 flex xl:z-30 w-full">
            <div className="self-start lg:h-[190px] flex-col justify-start items-start gap-2 flex">
            ...
            <div className="self-stretch 2xl:h-[167px] text-stone-900 text-sm font-medium lg:text-lg lg:font-normal leading-7">
          ...
          <div className="self-stretch max-2xl:hidden h-[58px] flex-col inset-x-0 bottom-0 justify-start items-start gap-2.5 flex">
            <BookAFreeDemoButton />
          </div>
        </div>
        <div className="w-full opacity-100 gap-x-4 flex-grow lg:h-[560px] h-full flex xl:z-20">
          <div className="w-[50%] relative h-full rounded lg:rounded-2xl">
            ...
            <div className="w-full h-[50.62px]   absolute bottom-0 flex-col flex justify-center items-center bg-gradient-to-b from-black/10 to-black/10 rounded-bl rounded-br">
              <div className="text-white text-5xl mt-[-6rem] font-bold ">
                Prachi
              </div>
              <div className="text-white text-3xl mt-2  ">French Trainer</div>
            </div>
          </div>
          <div className="w-[25%]  h-full   rounded relative lg:rounded-2xl">
            ...
            ></Image>
            <div className="w-full h-[50.62px]   absolute bottom-0 flex-col flex justify-center items-center bg-gradient-to-b from-black/10 to-black/10 rounded-bl rounded-br">
              <div className="text-white text-4xl mt-[-4rem] font-bold ">
                Samihan
              </div>
        ...
        <div className="self-center hidden lg:flex 2xl:hidden h-[58px] flex-col inset-x-0 bottom-0 justify-start items-start gap-2.5  ">
          <BookAFreeDemoButton />
        </div>
      </div>
    </div>
