...
const FluencyCultureCard = ({ datas }) => {
  return (
    <div className="flex flex-col p-6 shadow-md hover:shadow-xl transition duration-200 text-center bg-white rounded-2xl min-h-full lg:min-h-[548px] mx-2 md:mx-10 xl:mx-0  lg:mx-[50px] w-full xl:max-w-[400px] 2xl:max-w-[420px] 3xl:max-w-[450px] 4xl:w-[548px] max-md:px-5">
