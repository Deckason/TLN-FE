...
const FluencyCultureCard = ({ datas }) => {
  return (
    <div className="flex flex-col p-6 shadow-md hover:shadow-xl transition duration-200 text-center bg-white rounded-2xl min-h-full lg:min-h-[548px] mx-2 md:mx-0 md:max-w-sm 2xl:max-w-[500px] 4xl:max-w-[548px] 4xl:w-[548px] max-md:px-5">
