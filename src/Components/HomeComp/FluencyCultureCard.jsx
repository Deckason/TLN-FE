...
const FluencyCultureCard = ({ datas }) => {
  return (
    <div className="flex flex-col p-6 shadow-md hover:shadow-xl transition duration-200 text-center bg-white rounded-2xl min-h-full lg:min-h-[548px] mx-2 md:mx-0 md:max-w-sm lg:max-w-[500px] xl:max-w-[548px] max-md:px-5">
