...
const FluencyCultureCard = ({ datas }) => {
  return (
    <div className="flex flex-col p-6 4xl:shadow-md hover:shadow-xl transition duration-200 text-center bg-white rounded-2xl min-h-full lg:min-h-[400px] mx-2 md:mx-10 xl:mx-0 lg:mx-[50px] w-full max-w-[500px] xl:max-w-[380px] 2xl:max-w-[430px] 3xl:max-w-[450px] 4xl:w-[548px] max-md:px-5">
