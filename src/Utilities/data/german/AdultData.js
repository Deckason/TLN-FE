...
export const data = {
  ...
  Faqs: [
...

    {
      ...
      answer:
        "About 40% of German and German vocabulary are very similar to each other, which makes German one of the easiest languages to learn for native German speakers. So, basically, if you already know German, it should be a piece of cake for you to learn German.",
    },
